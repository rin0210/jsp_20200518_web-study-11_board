...
import com.saeyan.controller.action.BoardCommentAction;
import com.saeyan.controller.action.BoardReplyWriteActon;
import com.saeyan.controller.action.BoardReplyWriteFormAction;
...
public class ActionFactory {
	...
	public Action getAction(String command) {
		...
		if (command.equals("board_list")) {
			...
			action = new BoardReplyWriteFormAction();
		} else if (command.equals("reply_write")) {
			action = new BoardReplyWriteActon();
		}
		return action;
	}
}
